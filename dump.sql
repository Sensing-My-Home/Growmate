...
CREATE SEQUENCE public.air_quality_measurement_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE public.air_quality_measurement_id_seq OWNER TO postgres;

--
-- Name: air_quality_measurement_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.air_quality_measurement_id_seq OWNED BY public.air_quality_measurement.id;
...
--
-- Name: air_temperature_measurement_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.air_temperature_measurement_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE public.air_temperature_measurement_id_seq OWNER TO postgres;

--
-- Name: air_temperature_measurement_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.air_temperature_measurement_id_seq OWNED BY public.air_temperature_measurement.id;
...
--
-- Name: division_sensor_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.division_sensor_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE public.division_sensor_id_seq OWNER TO postgres;

--
-- Name: division_sensor_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.division_sensor_id_seq OWNED BY public.division_sensor.id;
...
--
-- Name: journal_entry_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.journal_entry_id_seq OWNER TO postgres;

--
-- Name: journal_entry_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--
...
--
-- Name: plant_sensor_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.plant_sensor_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE public.plant_sensor_id_seq OWNER TO postgres;

--
-- Name: plant_sensor_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.plant_sensor_id_seq OWNED BY public.plant_sensor.id;
...
--
-- Name: plant_species_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.plant_species_id_seq OWNER TO postgres;

--
-- Name: plant_species_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--
...
--
-- Name: soil_quality_measurement_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.soil_quality_measurement_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE public.soil_quality_measurement_id_seq OWNER TO postgres;

--
-- Name: soil_quality_measurement_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.soil_quality_measurement_id_seq OWNED BY public.soil_quality_measurement.id;
...
--
-- Name: species_family_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.species_family_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE public.species_family_id_seq OWNER TO postgres;

--
-- Name: species_family_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.species_family_id_seq OWNED BY public.species_family.id;
...
--
-- Name: air_quality_measurement id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.air_quality_measurement ALTER COLUMN id SET DEFAULT nextval('public.air_quality_measurement_id_seq'::regclass);


--
-- Name: air_temperature_measurement id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.air_temperature_measurement ALTER COLUMN id SET DEFAULT nextval('public.air_temperature_measurement_id_seq'::regclass);
...
--
-- Name: division_sensor id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.division_sensor ALTER COLUMN id SET DEFAULT nextval('public.division_sensor_id_seq'::regclass);


--
-- Name: journal_entry id; Type: DEFAULT; Schema: public; Owner: postgres
--
...
--
-- Name: plant_sensor id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.plant_sensor ALTER COLUMN id SET DEFAULT nextval('public.plant_sensor_id_seq'::regclass);


--
-- Name: plant_species id; Type: DEFAULT; Schema: public; Owner: postgres
--
...
--
-- Name: soil_quality_measurement id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.soil_quality_measurement ALTER COLUMN id SET DEFAULT nextval('public.soil_quality_measurement_id_seq'::regclass);


--
-- Name: species_family id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.species_family ALTER COLUMN id SET DEFAULT nextval('public.species_family_id_seq'::regclass);
...
SELECT pg_catalog.setval('public.air_quality_measurement_id_seq', 1, false);


--
-- Name: air_temperature_measurement_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.air_temperature_measurement_id_seq', 1, false);
...
--
-- Name: division_sensor_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.division_sensor_id_seq', 1, false);
...
--
-- Name: plant_sensor_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.plant_sensor_id_seq', 1, false);


--
-- Name: plant_species_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.plant_species_id_seq', 1, false);


--
-- Name: soil_quality_measurement_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.soil_quality_measurement_id_seq', 1, false);


--
-- Name: species_family_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.species_family_id_seq', 1, false);
...
SELECT pg_catalog.setval('public.utilizador_id_seq', 1, false);
